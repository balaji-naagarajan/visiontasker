    ...
    try:
        while True:
            ...
            #发送截图指示
                ...
                # result_js = process_img_script.process_img(label_path_dir, save_path_old, output_root, layout_json_dir, high_conf_flag,
                #             alg, clean_save, plot_show, ocr_save_flag, model_ver, model_det, model_cls, preprocess, ocr_only=ocr_output_only, 
                #             gpt4_text_size=gpt4_text_size, gpt4_text_thickness=gpt4_text_thickness)
